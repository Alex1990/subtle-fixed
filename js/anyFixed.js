...
function anyFixed(settings) {
    ...
    // If the element doesn't exist then throw an error
    if (!elem) {
        throw new Error('Unable to get the fixed element! Please check if the'
                + ' element exists or the spelling of identifier is correct.');
    }
